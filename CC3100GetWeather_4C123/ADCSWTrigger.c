...
//  while((SYSCTL_PRADC_R&0x0001) != 0x0001){};    // good code, but not yet implemented in simulator
  ...
  ADC0_ACTSS_R |= 0x0008;         // 14) enable sample sequencer 3
	ADC0_SAC_R  &= ~0x00000007;			// clears the bottom 3 bits so only one sample
//	ADC0_SAC_R |= 0x00000001;				// 2 sample averaging
//	ADC0_SAC_R |= 0x00000002;				// 4 sample averaging
//	ADC0_SAC_R |= 0x00000003;				// 8 sample averaging
//	ADC0_SAC_R |= 0x00000004;				// 16 sample averaging
//	ADC0_SAC_R |= 0x00000005;				// 32 sample averaging
	ADC0_SAC_R |= 0x00000006;				// 64 sample averaging
